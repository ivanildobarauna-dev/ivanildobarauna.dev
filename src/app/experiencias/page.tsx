            ...
            >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-100">Tempo total: {duracaoTexto}</p>
                    </div>
                  </div>
                  {exps[0].website && (
                    <a
              ...
              <div className="p-6 space-y-6">
                {exps.map((exp, index) => (
                  ...
                  >
                    <h3 className="text-xl font-bold text-blue-600 mb-2">{exp.cargo}</h3>
                    ...
                    {exp.habilidades && exp.habilidades.length > 0 && (
                      <div className="mt-4">
                        <h4 className="text-sm font-semibold text-gray-600 mb-2">Habilidades Técnicas:</h4>
